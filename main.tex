...
\begin{remark}
  \citet{homotopy-theoretic-aspects} defines model category structure $T\text{-Alg}_s$, the category of strict algebras and their strict morphisms for a 2-monad $T$ on a model $\mathrm{Gpd}$-category.
  ...
  Thus $\mathrm{sLcc}$ and $T\text{-Alg}_s$ have the same sets of weak equivalences and trivial fibrations, hence their model category structure agrees.
\end{remark}
