...
\end{itemize}
A context extension $\Gamma.\sigma$ is interpreted as the domain of $\sigma$, application of substitutions $f : \Delta \rightarrow \Gamma$ to types $\Gamma \vdash \sigma$ is interpreted as pullback
\begin{equation}
  \begin{tikzcd}
...
The morphisms in $I$ are used to enforce that the domains of maps marked as evaluation maps of dependent products are marked as pullback squares.
...
\begin{definition}
  ...
  The model category $\mathrm{Lcc}$ of \emph{lcc sketches} is the left Bousfield localization of the model category of $I_\mathrm{Lcc}$-marked categories at the following morphisms.
  \begin{itemize}
    \item
