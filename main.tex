...
\begin{proof}
  ...
  % Lambda abstraction and its inverse is defined via the adjunction $_\sigma \dashv \Pi'_\sigma$, which establishes an isomorphism of morphisms $t : 1 = p_\sigma(1) \rightarrow \tau$ in $\Gamma.\sigma$ with morphisms $u : 1 \rightarrow \rightarrow \Pi'_\sigma(\tau)$ in $\Gamma$, i.e.\@ of terms $\Gamma.\sigma \vdash t : \tau$ with terms $\Gamma \vdash u : \mathbf{\Pi}_\sigma \, \tau$.
