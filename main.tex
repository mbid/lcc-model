...
\begin{proof}
  ...
  The only additional assumption for the enriched version of Beck's theorem we have to check is that the coequalizer of a $G$-split pair of morphisms as constructed in \cite{algebraic-models} is a colimit also in the enriched sense.
